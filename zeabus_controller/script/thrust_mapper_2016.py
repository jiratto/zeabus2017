...
#			 [ 0.45728, 0.19104, 0.03993]])
	#tul
	#self.r = array([[ 0.23594,-0.20304, 0],
        #                 [-0.23594,-0.20304, 0],
        #                [-0.23594, 0.20304, 0],
        #                 [ 0.23594, 0.20304, 0],
        #                [ 0.45728,-0.19104, 0],
...
#                [0.330, -0.150, 0.080+0.044]])
	...
	F = array([message.linear.x*3, -message.linear.y*3, message.linear.z*0,
		   message.angular.x*0, message.angular.y*0, message.angular.z*2.4])
	print '======= F ========'
	print F
	print F.T
	t = dot(self.M, F.T)
