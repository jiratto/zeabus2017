...
class AIControl():
    def __init__(self):
        ...
        rospy.Subscriber('/controller/is_at_fix_position',
                         Bool, self.fix_position)
        rospy.Subscriber('/controller/is_at_fix_orientation',
        ...
        # self.driveXYService = rospy.ServiceProxy('fix_rel_x_srv', drive_xaxis)
